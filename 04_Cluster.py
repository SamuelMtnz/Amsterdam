...
# --------------------------------------------
  ...
  # --------------------------------------------
  # EEscalar datos (necesario para SVR, Ridge, Lasso)
  # --------------------------------------------
...
# Primero: Crear directorio para modelos
MODELS_DIR = Path("models")
MODELS_DIR.mkdir(exist_ok=True, parents=True)

# Segundo: Guardar modelo KMeans para Streamlit
joblib.dump(kmeans, MODELS_DIR / "kmeans_model.pkl")

# Tercero: Preparar y guardar modelo especial para Zona 0
...
# Cuarto: Guardar datos con clusters para mapas
df_house_cluster.to_csv('datos_cluster.csv', index=False)
