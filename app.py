...
# Ruta para acceder al localhost

#  cd "C:\Users\Samu\Documents\Nodd3r\Amsterdam"
...
def cargar_datos():
    try:
        df = pd.read_csv(BASE_DIR / 'datos_cluster.csv')
...
# Mapeo de colores por zona (consistente con tu análisis)
colores_zonas = {
    0: "red",     # Centro
    1: "green",   # Sureste
    2: "purple",  # Oeste
...
# ===========================================
# SECCIÓN 2: PREDICCIÓN DE PRECIOS (SOLUCIÓN PARA ZONA 0)
# ===========================================
st.divider()
...
if calcular_btn:
    try:
        ...
        # SOLUCIÓN: Manejar características específicas para cada modelo
        if zona_seleccionada == 0:
            # Características ESPECÍFICAS para el modelo de Zona 0
        ...
        # Crear array de valores en el orden CORRECTO
...
# Si ya existe una predicción en sesión, usarla
...
# ===========================================
# SECCIÓN 3: ANÁLISIS DE ZONAS (MODIFICADA)
# ===========================================
st.divider()
st.header("📈 Análisis por Zonas")

# Gráfico de precios por zona (se mantiene)
